local camera = cloneref(game:GetService("Workspace")):FindFirstChildOfClass("Camera")
local drawingUI = Instance.new("ScreenGui", gethui and gethui() or cloneref(game:GetService("CoreGui")))
drawingUI.Name = "RobloxGui"
